...
- `here("data", "counts.tsv")` → `/blue/bioinf_workshop/$USER/rnaseq_workshop/data/counts.tsv`
- `here("results", "output.csv")` → `/blue/bioinf_workshop/$USER/rnaseq_workshop/results/output.csv`
...
After running the data preparation script, you'll find in `demo-analysis/output/`:
