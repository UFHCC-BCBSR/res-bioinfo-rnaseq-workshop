...
- `here("demo-analysis", "output", "counts.tsv")` → `/blue/bioinf_workshop/$USER/rnaseq_workshop/data/counts.tsv`
- `here("demo-analysis", "output", "results", "output.csv")` → `/blue/bioinf_workshop/$USER/rnaseq_workshop/results/output.csv`
...
- Write processed files to YOUR repo's `demo-analysis/output/` directory
